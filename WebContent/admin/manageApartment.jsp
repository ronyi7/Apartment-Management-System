			...
			<table class="table table-bordered datatable" id="table-1">
				...
				<c:forEach items="${sessionScope.search_apartments }" var="i">
					<tr class="odd gradeX">
						...
						<td>${i.zip_code }</td>
						<td>${i.price }</td>
						<td>${i.rental_status }</td>
						
						<td>
						<a href="<%=request.getContextPath()%>/addApartmentController?flag=edit_apartments&apartment_id=${i.apartment_id}">EDIT</a> 
											/ <a onclick="return confirmDelete()" href="<%=request.getContextPath()%>/addApartmentController?flag=delete_apartment&apartment_id=${i.apartment_id}">DELETE</a>
						</td>
