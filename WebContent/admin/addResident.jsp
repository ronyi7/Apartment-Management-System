	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addResidentController?flag=add" method="post" role="form">
					...
					<div class="form-group">
						...
						<option value="${i.apartment_id }">${i.address}, ${i.city }, ${i.state } - ${i.zip_code }</option>
						</c:forEach>
						</select>
						</div>
						</div>
