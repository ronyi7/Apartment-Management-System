			...
			<table class="table table-bordered datatable" id="table-1">
				...
				<c:forEach items="${sessionScope.list_of_all_request }" var="i">
					<tr class="odd gradeX">
						...
						<td>
						<a href="<%=request.getContextPath()%>/addApartmentController?flag=assign_username_password&rental_request_id=${i.rental_request_id}"><input type="button" class="btn btn-primary" value="Assign UserName & Password"></a> 
											/ <a onclick="return confirmDelete()" href="<%=request.getContextPath()%>/addApartmentController?flag=delete_rental_request&rental_request_id=${i.rental_request_id}"><input type="button" class="btn btn-primary" value="DELETE"></a>
						</td>
