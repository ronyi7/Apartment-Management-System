	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				<c:forEach items="${sessionScope.edit_rental_request }" var="x">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addResidentController?flag=add_requested_rental_as_resident" method="post" role="form">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">First Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter First Name" disabled="disabled" class="form-control" value="${x.first_name }">
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">Last Name</label>
						<div class="col-sm-5">
							<input type="text" disabled="disabled" class="form-control" value="${x.last_name}">
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">Email Id</label>
						<div class="col-sm-5">
							<input type="text" disabled="disabled" class="form-control" value="${x.email_id}">
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">Phone No.</label>
						<div class="col-sm-5">
							<input type="text" disabled="disabled" class="form-control" value="${x.phone_no}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea disabled="disabled" class="form-control" >${x.address }</textarea>
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">User-Name*</label>
						<div class="col-sm-5">
							<input type="text" name="userId" required="required" class="form-control" placeholder="Assign User Name">
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">Password*</label>
						<div class="col-sm-5">
							<input type="password" name="password" required="required" class="form-control" placeholder="Assign Password">
						</div>
					</div>
					
					
						
						<input type="hidden" value="${x.rental_request_id}" name="rental_request_id"/>
						<input type="hidden" value="${x.addApartmentVO.apartment_id}" name="apartmentID"/>
						<input type="hidden" value="${x.first_name}" name="firstName"/>
						<input type="hidden" value="${x.last_name}" name="lastName"/>
						<input type="hidden" value="${x.email_id}" name="emailId"/>
						<input type="hidden" value="${x.address}" name="address"/>
						<input type="hidden" value="${x.phone_no}" name="phoneNo"/>
						<input type="hidden" name="userType" value="resident"> 
						<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button class="btn btn-primary" type="submit" >Assign User-Name & Password</button>
