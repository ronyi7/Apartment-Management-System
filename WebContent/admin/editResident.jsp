	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				...
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addResidentController?flag=update" method="post" role="form">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							First Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter First Name" name="firstName" class="form-control" value="${x.first_name}">
						</div></div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Last Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter Last Name" name="lastName" class="form-control" value="${x.last_name }">
						</div></div>
						<div class="form-group">
						...
						<label class="col-sm-3 control-label" for="field-1">
							Email Id</label>
						<div class="col-sm-5">
							<input type="email" placeholder="abc@gmail.com" name="emailId" class="form-control" value="${x.email_id }">
						</div></div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Phone No.</label>
						<div class="col-sm-5">
							<input type="text" placeholder="(xxx)xxxxxxx" name="phoneNo" class="form-control" value="${x.phone_no }">
						</div></div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							UserId</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter User Id" name="userId" class="form-control" value="${x.user_id }">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Password</label>
						<div class="col-sm-5">
							<input type="password" placeholder="Enter Password" name="password"	class="form-control" value="${x.password }">
						</div>
					</div>
						<input type="hidden" value="${x.resident_id}" name="residentId"/>
