			...
			<table class="table table-bordered datatable" id="table-1">
				...
				<c:forEach items="${sessionScope.search_residents }" var="i">
					<tr class="odd gradeX">
						...
						<td>${i.user_id }</td>
						<td>
						<a href="<%=request.getContextPath()%>/addResidentController?flag=edit_residents&resident_id=${i.resident_id}">EDIT</a> 
											/ <a onclick="return confirmDelete()" href="<%=request.getContextPath()%>/addResidentController?flag=delete_resident&resident_id=${i.resident_id}">DELETE</a>
						</td>
