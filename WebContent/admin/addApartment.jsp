	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addApartmentController?flag=add" method="post" enctype="multipart/form-data" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="No. of Bedroom" Name="bedroom" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="No. of Bathroom" Name="bathroom" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea placeholder="Enter Aminities" name="amenities" class="form-control"></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Zip Code*</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter Zip Code" Name="zipCode" class="form-control">
						</div></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="Enter rental price per month" name="price" class="form-control">
						</div>
					</div>
