	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/requestServiceController?flag=add_reply" method="post" role="form">
					<c:forEach items="${sessionScope.list_of_resident }" var="x">
					<c:forEach items="${sessionScope.list_of_service }" var="i">
					
					<input type="hidden" name="resident_id" value="${x.resident_id }">
					<input type="hidden" name="service_id" value="${i.service_id }">
					
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">First Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter First Name" name="firstName" disabled="disabled" class="form-control" value="${x.first_name }">
						</div></div>
					
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">Last Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter Last Name" name="lastName" disabled="disabled" class="form-control" value="${x.last_name }">
						</div></div>
						<input type="hidden" name="emailId" value="${x.email_id }">
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">Email Id</label>
						<div class="col-sm-5">
							<input type="email" placeholder="abc@gmail.com" disabled="disabled" class="form-control" value="${x.email_id }">
						</div></div>
						...
						<label class="col-sm-3 control-label" for="field-1">
							Address</label>
						<div class="col-sm-5">
						<textarea  class="form-control" disabled="disabled" name="address" >${x.address }</textarea>
						</div></div>
						...
						<label class="col-sm-3 control-label" for="field-1">
							Service Type</label>
						<div class="col-sm-5">
							<input type="text" disabled="disabled" placeholder="serviceType" name="serviceType" class="form-control" value="${i.service_type }">
						</div></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						<textarea  class="form-control" disabled="disabled" name="serviceDescription">${i.service_description }</textarea>
						</div></div>
