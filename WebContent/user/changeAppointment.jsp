...
out.print("<p style='background-color:red; font-size:24px; color:white'><b>"+error +"</b></p>");
		...
		<div class="main-content">
			...
			<div>
			<h2 align="center"><br>Change an Appointment</h2></div>
			<br>
			<div class="panel-body">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addAppointmentController?flag=fetch" method="post" role="form">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button class="btn btn-primary" type="submit" >Change an Appointment</button>
