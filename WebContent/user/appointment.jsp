...
} %><form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addAppointmentController?flag=add" method="post" role="form">
       <c:forEach items="${sessionScope.apartments }" var="i">
			<input type="hidden" name="apt_address" value="${i.address }, ${i.city }, ${i.state }">
			<div>
			<h2 align="center"><br>Schedule an Appointment</h2>
			<h2 align="center"><br>for</h2>
			<h2 align="center"><br>${i.address }, ${i.city }, ${i.state }</h2>
			</div>
