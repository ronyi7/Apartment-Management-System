...
<br>
			...
			<c:forEach items="${sessionScope.edit_residents1 }" var="x">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addResidentController?flag=update1" method="post" role="form">
					...
					<div class="form-group">
						...
						<label class="col-sm-3 control-label" for="field-1">
							Email Id*</label>
						<div class="col-sm-5">
							<input type="email" disabled="disabled" required name="emailId" class="form-control" value=${x.email_id }>
						</div></div>
