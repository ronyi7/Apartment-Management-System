...
<br>
			<div class="panel-body">
				...
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addApartmentController?flag=addRental" method="post" role="form">
				...
				<input type="hidden" name="apartment_id" value="${i.apartment_id }"/> 
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
							<textarea placeholder="Enter full address" disabled="disabled" class="form-control">${i.address }, ${i.city }, ${i.state } - ${i.zip_code }.</textarea>
							</div>
						</div>
											
						<input type="hidden" name="address" value="${i.address }, ${i.city }, ${i.state } - ${i.zip_code }.">
