...
out.print("<p style='background-color:red; font-size:24px; color:white'><b>"+error +"</b></p>");
		...
		<div class="main-content">
			...
			<div>
			<h2 align="center"><br>Cancel an Appointment</h2></div>
			<br>
			<div class="panel-body">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addAppointmentController?flag=delete" method="post" role="form">
